...
Using the @ComponentScan annotation and passing the value of basePackage as
array having the base packages from where we need to get the classes having the
@Component or similar annotation to be autoconfigured in this class
 */
...
@DataJpaTest
@ComponentScan(basePackages = {"com.project.sdjpa_intro.bootstrap"})
public class SpringbootJpaTestSliceTwo {
